...
function updateGameboard(){
    ...
    for(let i=0 ; i<gameboard.board.length ; i++) {
        ...
        console.log(squares[2].textContent);
        //squares[i].textContent =  gameboard.board[i]; 
        // IDK this does not do what I expected. I can call squares[2] from the console, 
        //but apparently squares[i] is undefined
    }
}
function hello(){
    console.log("hello");
...
// Build the functions that allow players to add marks to a specific spot on the board, and then tie 
